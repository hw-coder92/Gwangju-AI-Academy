...
# 서울 문과  19.333333  65.333333  68.666667         # 인덱스도 2개 이상 가능하다.
#    이과  25.000000  65.000000  70.000000

print(df.groupby(["지역","전공"]).mean(numeric_only=True).sort_values("국어점수"))
...
# 부산   1   2
# 서울   3   4
print(df.groupby("지역")[['코딩',"이름"]].count()) # 널 체크용으로 쓰임